...
from src.skills.slop_detector.services.url_parser import parse
from src.skills.slop_detector.services.github_commits_api import fetch_commit_list, fetch_commit_detail
