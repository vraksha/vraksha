...
def fetch_raw_file(owner: str, repo: str, branch: str, path: str, max_bytes: int = 512000) -> str | None:
...
def fetch_file_via_contents_api(owner: str, repo: str, path: str, branch: str) -> dict | None:
    import base64
